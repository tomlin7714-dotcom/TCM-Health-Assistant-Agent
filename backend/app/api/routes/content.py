...
WORKOUTS: List[WorkoutOut] = [
    ...
    WorkoutOut(
        ...
        level="入门", students=15680, calories=120, actionsCount=5,
        ...
        actions=[
            WorkoutActionOut(order=1, title="开天辟地·唤醒阳气", keys="双脚与肩同宽，双臂从体侧缓缓上举过头，掌心朝天，踮脚尖拉伸脊柱，保持3个呼吸。", role="拉伸督脉，振奋全身阳气，打通任督二脉之气机。"),
            WorkoutActionOut(order=2, title="扭转乾坤·梳理带脉", keys="双手叉腰，以腰为轴缓缓左右扭转上身，头部随之转动，左右各8次。", role="疏通带脉和胆经，促进腰腹部气血循环，驱散中焦寒湿。"),
            WorkoutActionOut(order=3, title="拍打脾经·运化湿气", keys="双手空心掌，沿大腿内侧脾经循行路线由下往上轻拍，每条腿拍打30秒。", role="激活脾经气血，增强脾胃运化水湿功能，改善浮肿和困重。"),
            WorkoutActionOut(order=4, title="金鸡独立·引火归元", keys="单腿站立，另一脚贴于内侧膝部，双手合十于胸前，保持平衡30秒后换腿。", role="引气血下行，补肾固本，改善上热下寒体质，增强核心稳定。"),
            WorkoutActionOut(order=5, title="收功归田·气沉丹田", keys="双脚分开，双手从体侧缓缓下压至丹田位置，闭目静立，深呼吸3次。", role="将运动产生的阳气收敛入丹田，固本培元，使全身气血归于平和。"),
        ],
    ),
]

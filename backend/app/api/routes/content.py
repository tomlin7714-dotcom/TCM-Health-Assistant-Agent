...
WORKOUTS: List[WorkoutOut] = [
    ...
    WorkoutOut(
        ...
        actions=[
            WorkoutActionOut(order=1, title="托天理血·激活气血", keys="双脚分开与肩同宽，双手掌心向上从丹田缓缓托举过头，踮脚尖，吸气上托、呼气下落，反复9次。", role="牵拉任脉，激发全身气血运行，打开三焦通道。"),
            WorkoutActionOut(order=2, title="旋腕运血·疏通末梢", keys="双臂前伸与肩同高，手腕做内外旋转画圆，配合手指依次舒展握拢，正反各18圈。", role="刺激手腕部太渊、神门等穴位，促进末梢血液循环，改善手脚麻木。"),
            WorkoutActionOut(order=3, title="揉腹生血·健脾养胃", keys="双手叠放于腹部神阙穴，先顺时针揉腹36圈，再逆时针揉腹36圈，力度轻柔渗透。", role="健运脾胃、促进水谷精微化生气血，改善食欲和消化吸收。"),
            WorkoutActionOut(order=4, title="开合纳气·补益肺气", keys="双手于胸前做开合动作，打开时扩胸深吸气，合拢时收腹深呼气，动作缓慢均匀18次。", role="增强肺活量，肺主一身之气，肺气充足则气血生化有源。"),
            WorkoutActionOut(order=5, title="侧伸展筋·疏肝养血", keys="双臂上举合掌，身体向左右两侧缓慢侧弯拉伸，感受胁肋和体侧充分延展，每侧保持5个呼吸。", role="肝藏血主筋，拉伸肝经促进肝血输布，缓解情绪郁结导致的瘀血。"),
            WorkoutActionOut(order=6, title="踮脚振髓·补肾生髓", keys="双手叉腰，反复踮脚尖再落下，脚跟着地时微微震动脊柱，配合自然呼吸36次。", role="肾主骨生髓，髓能化血，刺激足少阴肾经促进精血互生。"),
            WorkoutActionOut(order=7, title="拍打八髎·温通下焦", keys="双手握空拳，交替拍打腰骶部八髎穴区域，力度以感到温热舒适为度，拍打1分钟。", role="温通下焦气血，改善宫寒痛经、腰膝酸冷等血虚寒凝症状。"),
            WorkoutActionOut(order=8, title="归元守一·气血归经", keys="双脚并拢站立，双手缓缓下压至丹田处重叠，闭目静立，意守丹田，深呼吸9次收功。", role="将运动激发的气血收敛归经，固本培元，使全身气血归于平和充盈。"),
        ],
    ),
]

...
RECIPES: List[RecipeOut] = [
    ...
    RecipeOut(
        ...
        time="40分钟", difficulty="入门",
        intro="百合润肺止咳清心安神，雪梨清热生津润燥化痰，两者相合为秋季润肺佳品，适合干咳少痰、咽干喉痛、皮肤干燥者。",
        ingredients=[
            IngredientOut(name="百合（干）", quantity="20克", icon="Heart"),
            IngredientOut(name="雪梨", quantity="2个", icon="Droplet"),
            IngredientOut(name="冰糖", quantity="适量", icon="Flame"),
            IngredientOut(name="枸杞子", quantity="5克", icon="Eye"),
        ],
        steps=["百合提前用温水泡发30分钟，雪梨去皮去核切块。",
               "将百合、雪梨块放入砂锅，加清水约1000毫升。",
               "大火煮沸后转小火炖30分钟，至雪梨透明软烂。",
               "加入冰糖和枸杞子，再煮5分钟至冰糖溶化。",
               "温热食用，汤料同食。"],
        image="/uploads/recipes/百合雪梨润肺汤.png",
    ),
    RecipeOut(
        id="r10", name="薏米赤小豆祛湿粥",
        benefits=["利水祛湿", "健脾消肿", "清热排毒"],
        time="60分钟", difficulty="入门",
        intro="薏米健脾利水渗湿，赤小豆利水消肿解毒，为经典的祛湿组合。适合湿气重、身体浮肿、舌苔厚腻、大便粘滞的人群。",
        ingredients=[
            IngredientOut(name="薏米", quantity="50克", icon="Sun"),
            IngredientOut(name="赤小豆", quantity="50克", icon="Award"),
            IngredientOut(name="茯苓", quantity="15克", icon="Compass"),
            IngredientOut(name="冰糖", quantity="适量", icon="Flame"),
        ],
        steps=["薏米和赤小豆提前用冷水浸泡4小时以上。",
               "茯苓用清水冲洗干净。",
               "将所有材料放入砂锅，加清水约1500毫升。",
               "大火煮沸后撇去浮沫，转小火慢熬50分钟。",
               "粥成粘稠，加冰糖调味，温热食用。"],
        image="/uploads/recipes/薏米赤小豆祛湿粥.png",
    ),
    RecipeOut(
        id="r11", name="党参黄芪补气鸡汤",
        benefits=["补气养血", "健脾益肺", "增强免疫"],
        time="120分钟", difficulty="中级",
        intro="党参补中益气健脾，黄芪补气升阳固表，搭配鸡肉炖汤，气血双补，适合气虚乏力、易感冒、面色苍白者。",
        ingredients=[
            IngredientOut(name="党参", quantity="15克", icon="Leaf"),
            IngredientOut(name="黄芪", quantity="15克", icon="Shield"),
            IngredientOut(name="土鸡（切块）", quantity="半只", icon="Award"),
            IngredientOut(name="红枣（去核）", quantity="6枚", icon="Heart"),
            IngredientOut(name="生姜", quantity="3片", icon="Sun"),
        ],
        steps=["鸡肉冷水下锅焯水去血沫，捞出洗净。",
               "党参、黄芪用清水浸泡15分钟。",
               "将所有材料放入砂锅，加清水约2000毫升。",
               "大火煮沸后撇去浮沫，转小火慢炖100分钟。",
               "出锅前加少许盐调味，汤肉同食。"],
        image="/uploads/recipes/党参黄芪补气鸡汤.png",
    ),
    RecipeOut(
        id="r12", name="菊花决明子降压茶",
        benefits=["清肝明目", "降压降脂", "润肠通便"],
        time="10分钟", difficulty="入门",
        intro="菊花清肝明目散风热，决明子清热明目润肠通便，为高血压、高血脂人群的理想代茶饮。",
        ingredients=[
            IngredientOut(name="杭白菊", quantity="6朵", icon="Eye"),
            IngredientOut(name="决明子（炒）", quantity="10克", icon="Shield"),
            IngredientOut(name="枸杞子", quantity="5克", icon="Heart"),
            IngredientOut(name="沸水", quantity="400毫升", icon="Zap"),
        ],
        steps=["决明子提前用小火炒至微香（或直接购买炒决明子）。",
               "将决明子、菊花、枸杞子放入杯中。",
               "倒入沸水约400毫升，盖上盖子闷泡10分钟。",
               "茶汤呈淡金黄色时即可饮用，可反复冲泡2-3次。"],
        image="/uploads/recipes/菊花决明子降压茶.png",
    ),
    RecipeOut(
        id="r13", name="核桃黑芝麻补肾糊",
        benefits=["补肾固精", "乌发养颜", "润肠通便"],
        time="20分钟", difficulty="入门",
        intro="核桃补肾温阳健脑，黑芝麻补肝肾益精血乌须发，适合肾虚腰痛、须发早白、记忆力减退者。",
        ingredients=[
            IngredientOut(name="核桃仁", quantity="30克", icon="Award"),
            IngredientOut(name="黑芝麻", quantity="30克", icon="Sun"),
            IngredientOut(name="糯米", quantity="20克", icon="Leaf"),
            IngredientOut(name="红糖", quantity="适量", icon="Flame"),
        ],
        steps=["黑芝麻提前用小火炒香，核桃仁掰成小块。",
               "糯米提前用清水浸泡2小时。",
               "将所有材料放入破壁机，加水约600毫升。",
               "选择米糊模式打成糊状，倒入碗中加红糖调味。",
               "温热食用，早晚各一小碗，坚持效果更佳。"],
        image="/uploads/recipes/核桃黑芝麻补肾糊.png",
    ),
    RecipeOut(
        id="r14", name="酸枣仁茯苓安神粥",
        benefits=["养心安神", "改善睡眠", "健脾祛湿"],
        time="50分钟", difficulty="入门",
        intro="酸枣仁养心补肝宁心安神，茯苓健脾利水宁心，专为失眠多梦、心烦不安、入睡困难者设计。",
        ingredients=[
            IngredientOut(name="酸枣仁（炒）", quantity="15克", icon="Heart"),
            IngredientOut(name="茯苓", quantity="15克", icon="Compass"),
            IngredientOut(name="粳米", quantity="50克", icon="Sun"),
            IngredientOut(name="桂圆肉", quantity="10克", icon="Eye"),
        ],
        steps=["酸枣仁捣碎用纱布包好，茯苓研成细末。",
               "粳米淘洗干净，与酸枣仁包一同放入砂锅。",
               "加清水约1000毫升，大火煮沸后转小火熬30分钟。",
               "取出酸枣仁包，加入茯苓粉和桂圆肉搅匀。",
               "再煮10分钟至粥浓稠，睡前2小时温热食用。"],
        image="/uploads/recipes/酸枣仁茯苓安神粥.png",
    ),
    RecipeOut(
        id="r15", name="桑葚枸杞滋阴膏",
        benefits=["滋阴补血", "养肝明目", "润肠通便"],
        time="90分钟", difficulty="中级",
        intro="桑葚滋阴补血生津润燥，枸杞滋补肝肾益精明目，慢火熬制成膏方便日常取食。",
        ingredients=[
            IngredientOut(name="桑葚（干）", quantity="100克", icon="Droplet"),
            IngredientOut(name="枸杞子", quantity="50克", icon="Eye"),
            IngredientOut(name="红枣（去核）", quantity="50克", icon="Heart"),
            IngredientOut(name="蜂蜜", quantity="100克", icon="Flame"),
        ],
        steps=["桑葚干用清水浸泡1小时，枸杞和红枣洗净。",
               "将所有材料（除蜂蜜外）放入锅中，加水约800毫升。",
               "大火煮沸后转小火慢熬60分钟，不断搅拌防粘锅。",
               "熬至浓稠膏状关火，稍凉后拌入蜂蜜搅匀。",
               "装入干净玻璃瓶冷藏，每日早晚各取一勺温水冲服。"],
        image="/uploads/recipes/桑葚枸杞滋阴膏.png",
    ),
    RecipeOut(
        id="r16", name="陈皮生姜暖胃饮",
        benefits=["理气暖胃", "温中散寒", "化湿止呕"],
        time="10分钟", difficulty="入门",
        intro="陈皮理气健脾燥湿，生姜温中散寒止呕，红糖暖胃驱寒，适合脾胃虚寒、胃脘冷痛、食后腹胀者。",
        ingredients=[
            IngredientOut(name="陈皮", quantity="5克", icon="Leaf"),
            IngredientOut(name="生姜", quantity="5片", icon="Sun"),
            IngredientOut(name="红糖", quantity="15克", icon="Flame"),
            IngredientOut(name="沸水", quantity="300毫升", icon="Zap"),
        ],
        steps=["陈皮用清水快速冲洗，生姜洗净切片。",
               "将陈皮和姜片放入杯中。",
               "倒入沸水约300毫升，盖上盖子闷泡10分钟。",
               "加入红糖搅拌至溶化，温热饮用。"],
        image="/uploads/recipes/陈皮生姜暖胃饮.png",
    ),
    RecipeOut(
        id="r17", name="莲子芡实健脾羹",
        benefits=["健脾固肾", "养心安神", "补中益气"],
        time="50分钟", difficulty="入门",
        intro="莲子补脾止泻益肾固精养心安神，芡实益肾固精补脾止泻，两者均属性平甘涩，为脾肾双补佳品。",
        ingredients=[
            IngredientOut(name="莲子（去心）", quantity="30克", icon="Heart"),
            IngredientOut(name="芡实", quantity="30克", icon="Shield"),
            IngredientOut(name="山药", quantity="20克", icon="Leaf"),
            IngredientOut(name="冰糖", quantity="适量", icon="Flame"),
        ],
        steps=["莲子、芡实提前用清水浸泡2小时。",
               "山药去皮切小块（戴手套防过敏）。",
               "将所有材料放入炖盅，加水约800毫升。",
               "隔水炖或小火煮45分钟，至莲子粉糯、芡实软烂。",
               "加入冰糖搅匀，温热食用。"],
        image="/uploads/recipes/莲子芡实健脾羹.png",
    ),
    RecipeOut(
        id="r18", name="玫瑰花佛手疏肝茶",
        benefits=["疏肝解郁", "理气和胃", "调经止痛"],
        time="10分钟", difficulty="入门",
        intro="玫瑰花疏肝解郁活血调经，佛手理气和胃燥湿化痰，适合压力大、情绪抑郁、经前乳胀、胸闷胁痛者。",
        ingredients=[
            IngredientOut(name="玫瑰花（干）", quantity="6朵", icon="Heart"),
            IngredientOut(name="佛手（干）", quantity="5克", icon="Leaf"),
            IngredientOut(name="枸杞子", quantity="5克", icon="Eye"),
            IngredientOut(name="蜂蜜", quantity="适量", icon="Flame"),
        ],
        steps=["玫瑰花和佛手用清水快速冲洗一遍。",
               "将所有材料放入玻璃杯中。",
               "倒入沸水约350毫升，盖上盖子闷泡8分钟。",
               "稍凉后加入蜂蜜调味，不宜用沸水冲蜂蜜。"],
        image="/uploads/recipes/玫瑰花佛手疏肝茶.png",
    ),
    RecipeOut(
        id="r19", name="冬瓜薏仁消肿汤",
        benefits=["清热利水", "消肿减肥", "健脾祛湿"],
        time="45分钟", difficulty="入门",
        intro="冬瓜清热利水消肿，薏仁健脾利水渗湿，低热量高纤维，适合水肿型肥胖、夏季暑湿、小便不利者。",
        ingredients=[
            IngredientOut(name="冬瓜（带皮）", quantity="300克", icon="Droplet"),
            IngredientOut(name="薏仁", quantity="40克", icon="Sun"),
            IngredientOut(name="生姜", quantity="3片", icon="Flame"),
            IngredientOut(name="盐", quantity="少许", icon="Compass"),
        ],
        steps=["薏仁提前用清水浸泡3小时。",
               "冬瓜连皮洗净切大块（带皮利水效果更好）。",
               ...
               "加少许盐调味，汤料同食。"],
        image="/uploads/recipes/冬瓜薏仁消肿汤.png",
    ),
    RecipeOut(
        id="r20", name="黄精首乌养发粥",
        benefits=["益精填髓", "乌发养颜", "补肝益肾"],
        time="60分钟", difficulty="中级",
        intro="黄精补气养阴健脾润肺益肾，何首乌补肝肾益精血乌须发，适合肝肾不足、须发早白、腰膝酸软者。",
        ingredients=[
            IngredientOut(name="黄精", quantity="15克", icon="Leaf"),
            IngredientOut(name="制何首乌", quantity="10克", icon="Award"),
            IngredientOut(name="黑米", quantity="50克", icon="Sun"),
            IngredientOut(name="黑豆", quantity="30克", icon="Shield"),
            IngredientOut(name="核桃仁", quantity="15克", icon="Heart"),
        ],
        steps=["黑米和黑豆提前用冷水浸泡4小时以上。",
               "黄精、制何首乌用清水浸泡20分钟。",
               "将所有材料放入砂锅，加清水约1200毫升。",
               "大火煮沸后撇去浮沫，转小火慢熬50分钟。",
               "待粥体浓稠、豆米软烂，撒入核桃仁搅匀，温热食用。"],
        image="/uploads/recipes/黄精首乌养发粥.png",
    ),
]
...
WORKOUTS: List[WorkoutOut] = [
    ...
    WorkoutOut(
        id="w7", name="古法气血养生操",
        subtitle="10分钟跟练版·补气养血·调和阴阳", teacher="国医堂 孙思邈 传人编排",
        level="入门", students=25680, calories=160, actionsCount=8,
        intro="本操专为气血不足人群编排，通过八个导引动作系统调理气血生化之源。融合经络拉伸、穴位刺激与呼吸导引，促进脾胃运化生血、肝藏血、心主血脉三大环节协调运作。适合面色萎黄、头晕乏力、手脚麻木、月经量少等气血亏虚人群，每日10分钟，坚持两周可见面色红润、精力充沛。",
        image="https://images.unsplash.com/photo-1518611012118-696072aa579a?auto=format&fit=crop&w=600&q=80",
        video_url="https://player.bilibili.com/player.html?bvid=BV1fqLwzfEsu&page=1&high_quality=1",
        actions=[
            WorkoutActionOut(order=1, title="踮腳擺手", keys="双脚与肩同宽，踮起脚尖同时双臂自然前后摆动，保持身体稳定，配合自然呼吸。", role="肾气充盈，刺激足少阴肾经，激发先天之气。"),
            WorkoutActionOut(order=2, title="後點甩臂", keys="双脚交替向后点地，双臂随之自然甩动，肩关节充分放松，动作舒展流畅。", role="全身舒畅，放松肩臂肌群，促进气血通达四肢末梢。"),
            WorkoutActionOut(order=3, title="馬步搖", keys="双脚分开略宽于肩，屈膝半蹲成马步，以腰胯为轴心做缓慢圆弧摇动，保持脊柱中正。", role="固本升阳，强壮腰肾，激活丹田之气。"),
            WorkoutActionOut(order=4, title="左右拉筋", keys="身体向左右两侧交替侧弯拉伸，手臂随之延展，感受体侧经络充分舒展，每侧保持3个呼吸。", role="通经活络、平衡阴阳，疏理肝胆经络气机。"),
            WorkoutActionOut(order=5, title="全身抖", keys="双脚微屈膝放松站立，全身做快速小幅抖动，从脚底向上传递至头顶，持续30秒至1分钟。", role="泄浊焕活，震动脉络排出浊气，焕新全身气血。"),
            WorkoutActionOut(order=6, title="升陽跳", keys="双臂合掌向上高举，身体充分延展，左右脚交替单跳，落地时屈膝缓冲，保持节奏。", role="三焦震荡醒阳法，通补上中下三焦，激发全身阳气。"),
            WorkoutActionOut(order=7, title="大鵬展翅", keys="双臂向两侧充分展开如大鹏展翅，肩胛骨向中间夹紧再放松，配合深吸深呼。", role="活肩胛、通三焦，刺激肩井穴和天宗穴，缓解肩颈淤堵。"),
            WorkoutActionOut(order=8, title="旋轉乾坤", keys="双脚开立，以腰为轴带动上半身做大幅度旋转，双臂随身体自然画圆，左右交替各9圈。", role="疏经活络，调和任督二脉，使全身气血归于周流不息。"),
        ],
    ),
]

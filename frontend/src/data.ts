...
export const MOCK_WORKOUTS: WorkoutItem[] = [
  {
    ...
    image: 'http://i1.hdslb.com/bfs/archive/f120cba41197becec8dd7c8e56e9b3d4744ed7d7.jpg',
  ...
  },
  {
    ...
    image: 'http://i1.hdslb.com/bfs/archive/d357696e95d3557a448798f35904eaccfcd1094a.jpg',
    videoUrl: 'https://player.bilibili.com/player.html?bvid=BV194YyzEE54&page=1&high_quality=1',
    actions: [
      { order: 1, title: '上下齊發', keys: '收紧核心，吸气踮起脚跟，呼气脚跟踩地，左右手臂交替向上下伸展。', role: '生发阳气、排出湿寒、缓解疲劳、促进新陈代谢。' },
      { order: 2, title: '前後撃掌', keys: '吸气双臂合掌向前，呼气展肩合掌向后，稳定根基。', role: '疏通经络、震荡脉气、加强血液循环、提高人体免疫功能。' },
      { order: 3, title: '大鵬展翅', keys: '自然呼吸，收紧核心，腋窝充分打开。', role: '刺激极泉穴、疏导心经郁火、扫除湿气。' },
      { order: 4, title: '左右搖擺', keys: '平衡好呼吸，稳定身体重心，手脚充分舒展。', role: '疏肝解郁、调节气血、强化脾胃功能、减少湿痰。' },
      { order: 5, title: '升陽跳', keys: '双臂合掌向上，身体充分延展，左右脚交替单跳。', role: '通补三焦、增强阳气、引火归元、赶走湿寒。' },
      { order: 6, title: '鷹擊長空', keys: '马步半蹲，核心发力，吸气抬双臂向上合掌、踮脚跟，呼气反之。', role: '通经活络、平衡阴阳、驱散湿寒、调和气血。' },
      { order: 7, title: '左右側拉', keys: '稳定身体重心，确保每处拉伸身体得到充分的延展。', role: '疏通经络、促进血液循环、带走身体毒素。' },
      { order: 8, title: '金龜吸水', keys: '核心发力，腿部充分拉伸，低血糖者建议放慢速度或者不做。', role: '升阳祛湿、锻炼身体平衡、扫除身体疲惫。' }
    ]
  },
  {
    id: 'w5',
    name: '古法健身脾胃操',
    subtitle: '增强食欲 · 促进消化 · 8式调理',
    teacher: '国医堂 王守义 教授编排',
    level: '入门',
    students: 18920,
    calories: 150,
    actionsCount: 8,
    intro: '本操融合传统养生功法，通过八个动作系统调理脾胃功能。结合双手上撑下按、深蹲刺激脾经、躯干扭转按摩脏腑、拍打腹股沟通下焦等技法，节奏舒缓，适合日常调理脾胃虚弱、食欲不振、腹胀消化不良等问题。建议每日练习15-20分钟。',
    image: 'http://i1.hdslb.com/bfs/archive/ee9c645220116eacca001766b46c6960f6ce8b81.jpg',
    videoUrl: 'https://player.bilibili.com/player.html?bvid=BV1A9VwzwEdY&page=1&high_quality=1',
    actions: [
      { order: 1, title: '八段锦单举 · 疏肝健脾', keys: '双手上撑下按做对称拉伸，左右交替，配合深呼吸，拉伸时吸气、还原时呼气。', role: '刺激脾胃经络，促进气血运行，调和肝脾之气。' },
      { order: 2, title: '托掌深蹲 · 疏通脾经', keys: '双手向上托掌，缓慢下蹲至大腿与地面平行，膝盖不超过脚尖，保持背部挺直。', role: '强化下肢气血循环，刺激足太阴脾经，改善腹胀乏力。' },
      { order: 3, title: '左右拧转 · 按摩脾胃', keys: '以腰腹为轴心带动躯干缓慢扭转，手臂随身体自然摆动，左右交替各8次。', role: '增强脾胃运化功能，缓解消化不良，促进胃肠蠕动。' },
      { order: 4, title: '合掌开合 · 疏肝理气', keys: '双手合掌于胸前，缓慢向两侧打开扩胸，再缓缓收回，配合深呼吸。', role: '调节肝胆气机，缓解情绪郁结，宽胸理气。' },
      { order: 5, title: '提膝扭转 · 改善胃胀', keys: '单腿提膝至胸前，同时上身向提膝侧扭转，双手自然摆动，左右交替。', role: '促进胃肠蠕动，缓解积食胀气，增强核心力量。' },
      { order: 6, title: '双手揉腹 · 促进消化', keys: '双手叠放于腹部，顺时针揉腹36圈再逆时针揉腹36圈，力度轻柔均匀。', role: '直接按摩脏腑，改善便秘及代谢，促进肠道蠕动。' },
      { order: 7, title: '拍打腹股沟 · 疏通下焦', keys: '双手空心掌，交替轻拍两侧腹股沟区域，力度适中，每侧拍打30秒。', role: '刺激脾经与淋巴系统，加速湿邪排出，改善下焦循环。' },
      { order: 8, title: '臀后弹踢 · 引火归元', keys: '双手叉腰，左右脚交替向后弹踢，脚跟尽量触碰臀部，保持身体稳定。', role: '刺激脾胃经，调和气血，改善上热下寒体质。' }
    ]
  },
  {
    id: 'w6',
    name: '古法健身升阳补气操',
    subtitle: '增强能量 · 提升阳气 · 8式导引',
    teacher: '国医堂 赵济民 教授编排',
    level: '入门',
    students: 21350,
    calories: 180,
    actionsCount: 8,
    intro: '本操融合传统导引术与经络学说，通过八个动作激发阳气、疏通三焦，专攻能量不足、畏寒体虚等问题。建议晨起练习，配合鼻吸口呼，长期坚持可改善疲劳乏力、手脚冰凉等阳虚症状，提升全天能量状态。',
    image: 'http://i0.hdslb.com/bfs/archive/a9fddfa617d7469b5bf6099c66abcb43f7acadd7.jpg',
    videoUrl: 'https://player.bilibili.com/player.html?bvid=BV1PRVPzuE4j&page=1&high_quality=1',
    actions: [
      { order: 1, title: '上下齐发 · 增加正气', keys: '双臂上举下按配合踮足，上举时吸气踮脚，下按时呼气落脚跟，牵拉任督二脉。', role: '疏通全身经络，激活气血循环，扶助正气。' },
      { order: 2, title: '前后踮足 · 强腰固肾', keys: '双脚与肩同宽，反复踮起脚跟再落下，身体保持直立，双手自然垂放体侧。', role: '刺激涌泉穴与肾经，改善腰膝酸软，强化先天元气。' },
      { order: 3, title: '马步升阳 · 提升阳气', keys: '双脚分开略宽于肩，屈膝半蹲成马步，双手握拳收于腰间，保持脊柱中正。', role: '打通肾经与督脉，驱逐寒湿邪气，缓解下肢冰凉。' },
      { order: 4, title: '踮足展胸 · 补益肾气', keys: '踮脚同时双臂向后扩胸展开，充分拉伸膈肌与胸胁区域，保持3个呼吸后放松。', role: '促进肺肾气机交汇，增强呼吸深度，补益肾气。' },
      { order: 5, title: '升阳跳 · 增强气力', keys: '弹跳配合手臂上举，落地时屈膝缓冲，动作轻快有节奏，呼吸自然配合。', role: '加速气血升发，改善代谢迟缓，适合久坐人群。' },
      { order: 6, title: '踮脚后扩拳 · 疏通肩背', keys: '踮脚站立，双手握拳向后扩胸出拳，展肩扩背，保持平衡。', role: '联动手三阳经与膀胱经，缓解肩颈僵硬，提升心肺功能。' },
      { order: 7, title: '踮脚抓手 · 固肾强腰', keys: '踮脚站立，双手向前做抓握虚空的反复动作，刺激手掌劳宫穴。', role: '实现心肾相交，改善手部麻木，固肾强腰。' },
      { order: 8, title: '拨天助肋 · 通调三焦', keys: '双臂上托过头向两侧展开，身体微微侧弯拉伸胁肋，左右交替。', role: '疏导三焦经气机，调和上热下寒体质，缓解胸闷腹胀。' }
    ]
  },
  {
    id: 'w7',
    name: '古法气血养生操',
    subtitle: '10分钟跟练版 · 补气养血 · 调和阴阳',
    teacher: '国医堂 孙思邈 传人编排',
    level: '入门',
    students: 25680,
    calories: 160,
    actionsCount: 8,
    ...
    image: 'http://i1.hdslb.com/bfs/archive/c020655760c938321ce0078a844dfb7be1b8706b.jpg',
    videoUrl: 'https://player.bilibili.com/player.html?bvid=BV1fqLwzfEsu&page=1&high_quality=1',
    actions: [
      { order: 1, title: '踮腳擺手', keys: '双脚与肩同宽，踮起脚尖同时双臂自然前后摆动，保持身体稳定，配合自然呼吸。', role: '肾气充盈，刺激足少阴肾经，激发先天之气。' },
      { order: 2, title: '後點甩臂', keys: '双脚交替向后点地，双臂随之自然甩动，肩关节充分放松，动作舒展流畅。', role: '全身舒畅，放松肩臂肌群，促进气血通达四肢末梢。' },
      { order: 3, title: '馬步搖', keys: '双脚分开略宽于肩，屈膝半蹲成马步，以腰胯为轴心做缓慢圆弧摇动，保持脊柱中正。', role: '固本升阳，强壮腰肾，激活丹田之气。' },
      { order: 4, title: '左右拉筋', keys: '身体向左右两侧交替侧弯拉伸，手臂随之延展，感受体侧经络充分舒展，每侧保持3个呼吸。', role: '通经活络、平衡阴阳，疏理肝胆经络气机。' },
      { order: 5, title: '全身抖', keys: '双脚微屈膝放松站立，全身做快速小幅抖动，从脚底向上传递至头顶，持续30秒至1分钟。', role: '泄浊焕活，震动脉络排出浊气，焕新全身气血。' },
      { order: 6, title: '升陽跳', keys: '双臂合掌向上高举，身体充分延展，左右脚交替单跳，落地时屈膝缓冲，保持节奏。', role: '三焦震荡醒阳法，通补上中下三焦，激发全身阳气。' },
      { order: 7, title: '大鵬展翅', keys: '双臂向两侧充分展开如大鹏展翅，肩胛骨向中间夹紧再放松，配合深吸深呼。', role: '活肩胛、通三焦，刺激肩井穴和天宗穴，缓解肩颈淤堵。' },
      { order: 8, title: '旋轉乾坤', keys: '双脚开立，以腰为轴带动上半身做大幅度旋转，双臂随身体自然画圆，左右交替各9圈。', role: '疏经活络，调和任督二脉，使全身气血归于周流不息。' }
    ]
  }
];
